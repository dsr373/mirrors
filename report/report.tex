...
\end{equation}
At large $\sigma$, $A$ approaches uniform illumination, $\psi$ tends to the Bessel function, and the FWHP will approach a constant value.

Besides, since the integral of $|A|$ over the aperture is smaller, the central intensity should be smaller with smaller $\sigma$, tending to 0 as $\sigma \rightarrow 0$.
